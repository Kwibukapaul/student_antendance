                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>institution</h3>
                            </a>
                            <h3>registrstion</h3>
                        </div>
                        <form action="add_institution.php" method="post" id="signupForm">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingText" placeholder="names" name="names">
                            <label for="floatingText">names</label>
                        </div>     
                        <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingUsername" placeholder="Physical Code" name="physicalcode">
                            <label for="floatingUsername">physical code</label>
                        </div>
                        <div class="form-floating mb-3">
