            ...
            <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <a href="index.html" class="">
                        <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>course</h3>
                    </a>
                    <h3>registration</h3>
                </div>
                <form action="add_course.php" method="post" id="signupForm">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <label for="floatingText">course_code</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingUsername" placeholder="Username" name="username">
                        <label for="floatingUsername">course_id</label>
                    </div>

                    <button type="submit" id="submitButton" class="btn btn-primary py-3 w-100 mb-4">add</button>
                </form>
            </div>
        </div>
    </div>
