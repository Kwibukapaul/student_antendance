...
try {
    ...
    // SQL query to retrieve data from the lecturers table
    ...
    if ($stmt->rowCount() > 0) {
        ...
        echo "<table>";
        echo "<tr><th>ID</th><th>Institution ID</th><th>Name</th><th>Phone</th><th>Email</th><th>Created By</th><th>Created At</th><th>Updated At</th></tr>";
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<td>";
            echo "<a href='update_student.php?id={$row["id"]}' class='btn btn-primary'>Update</a>";
            echo "<a href='enroll_lecturer.php?id={$row["id"]}' class='btn btn-success'>Enroll</a>";
            echo "</td>";
            echo "</tr>";
        }
        echo "</table>";
