...
try {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        echo "<table>";
        echo "<tr><th>ID</th><th>Name</th><th>Physical Code</th><th>Email</th><th>Phone</th><th>Created By</th><th>Created At</th><th>Updated At</th><th>Action</th></tr>";
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            echo "<tr>";
            echo "<td>" . $row["id"] . "</td>";
            echo "<td>" . $row["name"] . "</td>";
            echo "<td>" . $row["physical_code"] . "</td>";
            ...
            // Add update button
            echo "<td><a href='update_institution.php?id={$row["id"]}' class='btn btn-primary'>Update</a></td>";
            echo "</tr>";
        }
        echo "</table>";
    } else {
